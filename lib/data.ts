...
export const PARTNER_ID = process.env.GYG_PARTNER_ID || "DUOMOFLORENCE";
...
function gygLink(path: string, extra = "") {
  ...
  return `https://www.getyourguide.com/${trimmed}?partner_id=${PARTNER_ID}&utm_medium=online_publisher&cmp=florence-duomo${extra}`;
}
