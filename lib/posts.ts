...
const DEFAULT_CTA_HEADING = "Ready to climb Brunelleschi's Dome in Florence?";
const DEFAULT_CTA_BODY = "Compare official Brunelleschi passes, Giotto passes, and VIP guided climbs on our homepage.";
const DEFAULT_CTA_BUTTON_TEXT = "Compare Duomo Passes & Tickets";
const DEFAULT_CTA_BUTTON_HREF = "/#prices";
const DEFAULT_AUTHOR = "Duomo Florence Editorial Team / Italian Art Historians";
...
function seedToPost(seed: any): Post {
  return {
    ...
    focusKeyword: seed.focusKeyword || "Duomo Florence Tickets",
...
function rowToPost(row: any): Post {
  ...
  return {
    ...
    category: row.category || "Duomo Guides",
    excerpt: row.excerpt,
    ...
    recommendedTourId: row.recommended_tour_id || "brunelleschi-pass-all-inclusive-dome-climb",
    ...
    focusKeyword: row.focus_keyword || "Duomo Florence Tickets",
