...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Duomo Florence Tickets",
  metaDescription: "Privacy Policy for Duomo Florence Tickets — how we protect your information when exploring Florence Cathedral passes and Dome climb guides.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
