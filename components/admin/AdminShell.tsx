      ...
      >
        <aside className="hidden h-full w-64 flex-col bg-stone-900 text-white sm:flex">
          ...
          <div className="flex items-center gap-2.5 border-b border-white/10 px-5 py-5">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-roman-700 to-roman-900 text-gold-400 font-bold text-lg ring-1 ring-gold-400/40">
              ⚔️
            </span>
