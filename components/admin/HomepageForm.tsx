        ...
        <div className="space-y-5">
          ...
          >
            ...
            <Field label="Opening hours">
              <RepeatableList<HoursRow>
                ...
                renderItem={(row, upd) => (
                  <div className="grid gap-2 sm:grid-cols-2">
                    <input value={row.range} onChange={(e) => upd({ ...row, range: e.target.value })} placeholder="e.g. Brunelleschi's Dome" className={inputClass} />
          ...
          >
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Column 2" hint='e.g. "Dome Climb Access" — set per tour via its "Price table: Tasting / Drinks" field.'>
        ...
        <div className="space-y-5">
          <SectionCard title="Focus keyword" description="The main phrase you want the homepage to rank for. Purely a writing aid — nothing here is sent to Google.">
            <Field label="Focus keyword">
              <input value={content.focusKeyword} onChange={(e) => update("focusKeyword", e.target.value)} className={inputClass} placeholder="e.g. Duomo Florence tickets" />
            </Field>
            {focusChecklist && (
