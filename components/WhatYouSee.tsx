    ...
    <section className="py-20 sm:py-24 bg-[#FAF8F5] border-t border-[#EAE6DE]/70">
      <div className="mx-auto max-w-7xl px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column: Image of woman looking through circular window */}
          <div className="lg:col-span-6">
            <div className="relative aspect-[4/3] sm:aspect-[16/11] lg:aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl shadow-black/10">
              <Image
                src="/images/florence-window-view.jpg"
                alt="Woman looking through circular stone window at Florence skyline and Duomo"
                fill
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            <h2 className="mt-2.5 font-serif text-2xl sm:text-3xl lg:text-[2.15rem] font-bold text-[#112338] leading-[1.2] tracking-tight">
              A Masterpiece of Art, History<br className="hidden sm:inline" /> and Architecture
            </h2>

            {/* Terracotta Accent Line */}
            <div className="mt-3.5 mb-5 h-[2.5px] w-10 rounded-full bg-[#B85D3E]" />

            <p className="text-xs sm:text-[13.5px] text-[#556476] leading-relaxed max-w-lg">
              The Cathedral of Santa Maria del Fiore is the heart of Florence. Climb the Dome designed by Brunelleschi, explore centuries of art and history, and enjoy unforgettable views over the city.
            </p>
